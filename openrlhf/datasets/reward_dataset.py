...
class RewardDataset(Dataset):
    ...
    def __init__(
        ...
        # ===== 新增：存储 prompt length =====
        self.prompt_lens = processed_dataset["prompt_len"]
    ...
    def process_data(self, data):
        ...
        return {
            ...
            "chosen": chosen,
            "reject": reject,
            "extra": prompt_ids_len if self.is_dpo else margin,  # 保持原有逻辑
            "prompt_len": prompt_ids_len,  # 新增字段
        }
    ...
    def collate_fn(self, item_list):
        ...
        for chosen_id, chosen_mask, reject_id, rejects_mask, extra, prompt_len in item_list:
        ...
        # ===== 新增：返回 prompt_lens =====
        return chosen_ids, chosen_masks, reject_ids, rejects_masks, extras, prompt_lens
