...
from openrlhf.models import ValueLoss, get_llm_for_sequence_regression, get_llm_for_sequence_regression_ppo_critic
...
class CriticModelActor(BaseModelActor):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain, max_steps):
        ...
        critic = get_llm_for_sequence_regression_ppo_critic(
            pretrain,
            ...
            latent_dim_c=strategy.args.latent_dim_c,
            enc_hidden=strategy.args.enc_hidden,
        )
