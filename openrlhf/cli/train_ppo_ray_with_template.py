...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--reward_model_type",
        type=str,
        default="causal_reward",
        choices=["reward", "causal_reward"],
        help="Type of reward model: 'reward' for standard, 'causal_reward' for CRM"
    )

    # CRM-specific hyperparameters
    parser.add_argument("--latent_dim_c", type=int, default=128)
