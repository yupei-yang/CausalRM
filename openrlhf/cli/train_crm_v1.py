...
from openrlhf.trainer.crm_trainer_v1 import CausalRewardModelTrainer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--latent_dim_c", type=int, default=64)
    parser.add_argument("--latent_dim_nc", type=int, default=64)
